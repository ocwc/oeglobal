...
<div class="contentheader-strip text-light
              @if($background_image) with-bg-image @endif" @if($background_image)style="background-image: url({!! $background_image !!}" @endif>
...
@else
<div class="contentheader-strip text-light
      @if ($attribution) mb-2 @else mb-12 @endif" @if($background_image)style="background-image: url({!! $background_image !!}" @endif>
  <div class="container flex flex-col justify-center">
